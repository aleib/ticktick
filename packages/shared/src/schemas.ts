...
const requiredUnknownSchema = z.unknown().refine((v) => v !== undefined, "Required");
...
export const recurrenceRuleSchema: z.ZodType<RecurrenceRule> = z.union([
  z.object({
    ...
    byWeekdays: z.array(z.union([z.literal(1), z.literal(2), z.literal(3), z.literal(4), z.literal(5), z.literal(6), z.literal(7)])).optional(),
...
export const taskSchema: z.ZodType<Task> = z.object({
  ...
  targetDailyMinutes: z.number().int().positive().nullable(),
  targetWeeklyMinutes: z.number().int().positive().nullable(),
...
export const mutationSchema: z.ZodType<Mutation, z.ZodTypeDef, MutationInput> = z.object({
  id: uuidSchema,
...
export const runningTimerStateSchema: z.ZodType<RunningTimerState> = z.object({
  ...
  pomodoro: z
    .object({
      phase: z.union([z.literal("work"), z.literal("shortBreak"), z.literal("longBreak")]),
